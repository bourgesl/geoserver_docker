...
ADD marlin-0.9.4.4-Unsafe.jar /usr/local/tomcat/
ADD marlin-0.9.4.4-Unsafe-sun-java2d.jar /usr/local/tomcat/

ENV MARLIN_JAR_PREFIX="/usr/local/tomcat/marlin-0.9.4.4-Unsafe"
